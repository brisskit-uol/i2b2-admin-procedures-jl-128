...
<xsl:stylesheet version="2.0"
                ...
                xmlns:rev="http://brisskit.org/xml/onyxmetadata-rev/v1.0/rev" >
...
<!--+=================================================================================-->
	...
	<xsl:template name="insertTop" >
	   <xsl:text>INSERT INTO CIVICRM( C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE, C_METADATAXML, C_FACTTABLECOLUMN, C_TABLENAME, C_COLUMNNAME, C_COLUMNDATATYPE, C_OPERATOR, C_DIMCODE, C_COMMENT, C_TOOLTIP, UPDATE_DATE, DOWNLOAD_DATE, IMPORT_DATE, SOURCESYSTEM_CD, VALUETYPE_CD )</xsl:text>
	   <xsl:text>&#xA;</xsl:text>
