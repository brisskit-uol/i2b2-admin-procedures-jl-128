...
OUTPUT_DIR=$I2B2_ADMIN_PROCS_WORKSPACE/$JOB_NAME/$METADATA_SQL_DIRECTORY/$DB_TYPE/ontcell
#
# And it must exist!
if [ ! -d $OUTPUT_DIR ]
then
...
STYLESHEET=$I2B2_ADMIN_PROCS_HOME/xslt/$DB_TYPE/ont_cell_enumerations_${DB_TYPE}.xsl
