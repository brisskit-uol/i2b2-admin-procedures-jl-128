#!/bin/bash
#-----------------------------------------------------------------------------------------------
# Takes the enumerated refined metadata files (> 600 of them) and produces SQL inserts for 
...
STYLESHEET=$I2B2_ADMIN_PROCS_HOME/xslt/$DB_TYPE/ont_dim_enumerations_${DB_TYPE}.xsl
