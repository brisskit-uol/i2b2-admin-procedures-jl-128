...
# but DOES NOT upload meta data or participant data.
#
...
#===========================================================================
# METADATA CREATE AND STATIC LOAD: CUSTOMER WITH BOTH ONYX AND CATISSUE
#===========================================================================
#
...
$ANT_HOME/bin/ant -propertyfile $I2B2_ADMIN_PROCS_HOME/config/config.properties \
                  ...
                  create_onyx_and_catissue_metadata_tables \
                  >>$LOG_FILE 2>>$LOG_FILE
...
$ANT_HOME/bin/ant -propertyfile $I2B2_ADMIN_PROCS_HOME/config/config.properties \
                  -Dproc.home=$I2B2_ADMIN_PROCS_HOME \
                  -f $I2B2_ADMIN_PROCS_HOME/ant/$DB_TYPE/project-install-build.xml \
                  load_onyx_and_catissue_static_metadata \
                  >>$LOG_FILE 2>>$LOG_FILE
