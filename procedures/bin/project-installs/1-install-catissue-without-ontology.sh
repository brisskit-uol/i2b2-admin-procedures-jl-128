#!/bin/bash
#-----------------------------------------------------------------------------------------------
# Installs an CaTissue project but DOES NOT upload meta data or participant data.
#
...
#===========================================================================
# METADATA CREATE AND STATIC LOAD: CUSTOMER WITH CATISSUE ONLY
#===========================================================================
#
...
$ANT_HOME/bin/ant -propertyfile $I2B2_ADMIN_PROCS_HOME/config/config.properties \
                  ...
                  -f $I2B2_ADMIN_PROCS_HOME/ant/$DB_TYPE/project-install-build.xml \
                  create_catissue_metadata_tables \
                  >>$LOG_FILE 2>>$LOG_FILE
...
merge_config_properties \
            ...
            $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/hive/inserts/crc_db_lookup_${DB_TYPE}_insert_data.sql \
            $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/hive/inserts/crc_db_lookup_${DB_TYPE}_insert_data.sql.tmp         
exit_if_bad $? "Failed to merge properties into $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/hive/inserts/crc_db_lookup_${DB_TYPE}_insert_data.sql.tmp" $LOG_FILE  

merge_config_properties \
            $I2B2_ADMIN_PROCS_HOME/config/config.properties \
            $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/hive/inserts/ont_db_lookup_${DB_TYPE}_insert_data.sql \
            $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/hive/inserts/ont_db_lookup_${DB_TYPE}_insert_data.sql.tmp         
exit_if_bad $? "Failed to merge properties into $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/hive/inserts/ont_db_lookup_${DB_TYPE}_insert_data.sql.tmp" $LOG_FILE  

merge_config_properties \
            $I2B2_ADMIN_PROCS_HOME/config/config.properties \
            $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/hive/inserts/work_db_lookup_${DB_TYPE}_insert_data.sql \
            $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/hive/inserts/work_db_lookup_${DB_TYPE}_insert_data.sql.tmp         
exit_if_bad $? "Failed to merge properties into $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/hive/inserts/work_db_lookup_${DB_TYPE}_insert_data.sql.tmp" $LOG_FILE  
...
rm -f $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/hive/inserts/*_db_lookup_${DB_TYPE}_insert_data.sql.tmp
...
merge_config_properties \
            $I2B2_ADMIN_PROCS_HOME/config/config.properties \
            $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/pm/inserts/pm_access_insert_data.sql \
            $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/pm/inserts/pm_access_insert_data.sql.tmp
exit_if_bad $? "Failed to merge properties into $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/pm/inserts/pm_access_insert_data.sql.tmp" $LOG_FILE 
...
#
# Remove the temporary files...
rm -f $I2B2_ADMIN_PROCS_HOME/sql/${DB_TYPE}/pm/inserts/pm_access_insert_data.sql.tmp
